...
const IconFacebook: React.FC = () => (
    <span className="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[--custom-color] transition duration-200 ease-in-out hover:scale-110">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" aria-label="Facebook icon" role="img">
            <path
